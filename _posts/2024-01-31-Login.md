      ...
      fetch("http://127.0.0.1:8086/api/users/authenticate", requestOptions)
          .then(response => {
            if (response.ok) {
                ...
                window.location.href = "https://sris126.github.io/student/"
              } else {
  ...
  <form action="javascript:login_user()">
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='https://sris126.github.io/student/'" class="button-spacing" >Sign Up</button>
    </p>
  </form>
