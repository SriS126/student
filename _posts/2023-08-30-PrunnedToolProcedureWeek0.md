...
description: Used for setting up Github Page and installing necessary tools
...
## Steps
1. Install VSCode if haven't done so already
2. Install Anaconda 
3. Copy and paste homebrew installation steps into terminal from github page in teacher 
4. Copy and paste jupyter installation steps into terminal from github page in teacher 
